...
#ler somenete os arquivos filtrados
df_states = pd.read_csv("df_states.csv")
df_brasil = pd.read_csv("df_brasil.csv")

#montar o mapa com base no brazil_geo.json como seomente leitura ("r")
...
app.layout = dbc.Container(
    children=[
        dbc.Row([
            dbc.Col([
                    html.Div([
                        html.Img(id="logo", src=app.get_asset_url("logo_dark.png"), height=70),
